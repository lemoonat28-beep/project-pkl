...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Pendaftaran berhasil! Silakan login.'); window.location.href='user-login.php';</script>";
    } else {
...
<head>
    ...
    <title>Registrasi Pekerja - PT.UBL</title>
    <link rel="stylesheet" href="registrasi.css">
</head>
<body>
    <div class="register-card">
        <div class="register-header">
            <h2>Registrasi Pekerja Baru</h2>
            <p>Buat ID Card Digital Anda</p>
        </div>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <div class="form-grid">
                <div class="input-group">
                    ...
                    <input type="text" name="nama_pendek" placeholder="Zean" required>
                </div>
                ...
                <div class="input-group full-width">
                    ...
                    <input type="text" name="nama_lengkap" placeholder="Zean Tristyan" required>
                </div>

                <div class="input-group full-width">
                    <label>Jabatan / Posisi</label>
                    <input type="text" name="role" placeholder="Web Developer / IT Support" required>
                </div>

                <div class="input-group full-width">
                    <label>Alamat Domisili</label>
                    <input type="text" name="alamat" placeholder="Tangerang Kota" required>
                </div>

                <div class="input-group">
                    <label>Email Aktif</label>
                    <input type="email" name="email" placeholder="zean@gmail.com" required>
                </div>

               <div class="input-group">
                    <label>Password Akun</label>
                    <div class="password-wrapper">
                        <input type="password" id="pass-register" name="password" placeholder="••••••••" required>
                        <span class="toggle-password" onclick="togglePassword('pass-register', this)">👁️</span>
                    </div>
                </div>

                <div class="input-group full-width">
                    <label>Nomor WhatsApp</label>
                    <input type="text" name="no_telp" placeholder="+62 812-1234-4523" required>
                </div>
                ...
                <div class="input-group full-width">
                    ...
                    <div class="dropzone" id="dropzone" onclick="document.getElementById('file-input').click()">
                        ...
                        <p id="dropzone-text">📂 Tarik & Lepas foto di sini, atau <u>Klik untuk Memilih File</u></p>
            ...
            <div class="form-actions">
                <a href="user-login.php" class="btn-cancel">Batal</a>
